...
if [[ ${PV} == "9999" ]]; then
	...
	SRC_URI="https://github.com/huskyproject/${HUSKY_MODULE}/archive/${HUSKY_MODULE}-${PV}.tar.gz -> ${P}.tar.gz"
	KEYWORDS="~amd64 ~x86"
fi
...
DOCS="${S}/ChangeLog ${S}/HISTORY ${S}/README.md ${S}/file_id.diz"

multilib_src_install() {
	cmake_src_install
	insinto /etc/ftn
	newins ${S}/areastat.cfg areastat.conf.example
