...
DOCS="${S}/README.md ${S}/doc/Readme.en"

multilib_src_install() {
	cmake_src_install
	insinto /etc/ftn
	newins ${S}/${HUSKY_MODULE}.conf ${HUSKY_MODULE}.conf.example
	newins ${S}/route.add route.add.example.${HUSKY_MODULE}
	
	doman ${S}/${HUSKY_MODULE}.1
	doman ${S}/${HUSKY_MODULE}.conf.5
}