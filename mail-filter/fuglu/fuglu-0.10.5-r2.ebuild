...
RESTRICT="mirror"
SRC_URI="http://distfiles.overlay.junc.org/fidonet/${PN}-${PV}.tar.bz2 -> ${P}.tar.bz2"

LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="clamav database dkim milter spamassassin"
...
CDEPEND="dev-python/beautifulsoup:4[${PYTHON_USEDEP}]
		...
		milter? ( dev-python/python-libmilter[${PYTHON_USEDEP}] )"
