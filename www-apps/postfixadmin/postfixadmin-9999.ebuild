...
inherit user webapp git-2

DESCRIPTION="Web Based Management tool for Postfix style virtual domains and users"
HOMEPAGE="http://postfixadmin.sourceforge.net"
SRC_URI=""
EGIT_REPO_URI="git://github.com/postfixadmin/postfixadmin.git"

LICENSE="GPL-2"
KEYWORDS="~amd64 ~ppc ~x86"
IUSE="mysql postgres sqlite vacation xmlrpc"
...
DEPEND="vacation? ( dev-perl/DBI
	...
	dev-lang/php:5.6[unicode,imap,postgres?,xmlrpc?]
	dev-php/smarty
"
